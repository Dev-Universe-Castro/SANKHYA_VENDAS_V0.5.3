            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select 
                  ...
                  onValueChange={(value) => {
                    if (!condicaoComercialBloqueada && !condicaoComercialPorModelo) {
                      setPedido({ ...pedido, CODTIPVENDA: value })
                    }
                  }}
                  disabled={condicaoComercialBloqueada || condicaoComercialPorModelo}
                >
                  <SelectTrigger className={`border-gray-300 focus:border-green-500 focus:ring-green-500 ${(condicaoComercialBloqueada || condicaoComercialPorModelo) ? 'bg-gray-100 cursor-not-allowed' : ''}`}>
